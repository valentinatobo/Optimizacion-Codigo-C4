...
import App.servicies.ObjGraficosService;
import App.servicies.RecursosService;
...
public class LoginTemplate extends JFrame {
    ...
    public void crearJTextFields() {
        ...
        tNombreus = sObjGraficos.construirJTextField("", 10, 96, 300, 35, sRecursos.getColorAzulos(),
                Color.DARK_GRAY, Color.GRAY, null,
                sRecursos.getBorderAbajo(), "c"
        );
    ...
    public void crearJButons() {
        ...
        bRegistrarse = sObjGraficos.construirJButton(
                ...
                sRecursos.getColorAzulClaro(), sRecursos.getColorAzulcielo(), null, true
        );
        pArriba.add(bRegistrarse);

        //Boton icono de mas -------------------------------------------------------------------------------------------------------------------------------
        iDimaux = new ImageIcon(iPuntos.getImage().getScaledInstance(45, 30, Image.SCALE_AREA_AVERAGING));
        ...
        bContraseña = sObjGraficos.construirJButton("¿Olvidaste tu contraseña?", 53, 295, 220, 45, sRecursos.getcMano(), null, sRecursos.getFontTitulos(),
                sRecursos.getColorAzulos(), Color.GRAY, null, true);
        ...
        bICon = sObjGraficos.construirJButton(
                ...
                sRecursos.getColorAzulos(), null, null, true
        );
        pMedio.add(bICon);
        ...
        bEntrar = sObjGraficos.construirJButton(
                ...
                sRecursos.getColorAzulcielo(), Color.WHITE, null, true
        );
        pAbajo.add(bEntrar);
    }
    ...
    public void crearJPaswordFields() {
        ...
        tClaveus = sObjGraficos.construirJPasswordField("", 10, 166, 300, 35, sRecursos.getColorAzulos(), Color.WHITE, sRecursos.getColorAzulcielo(),
                null, sRecursos.getBorderAbajo(), "c"
        );
        pMedio.add(tClaveus);
